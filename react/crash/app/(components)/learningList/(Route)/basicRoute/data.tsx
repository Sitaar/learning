...
export const data = {
      ...
      list: [
        {
          ...
          cookingtime: "10-20分钟",
          content:
            "醋溜白菜，是北方人经常吃的一道菜，尤其是在多年前的冬天。那时，没有大棚菜，冬天，家家每天佐餐的基本上都是冬储大白菜，聪明的家庭主妇总是想方设法将这单调的菜变成多种菜式，于是，醋溜白菜被频繁的端上餐桌。<br />美食不分贵贱，用最平凡的原料、最简单的调料和最普通的手法做出美味的菜肴来才是美食的真谛。 <br />这次，我做的醋溜白菜，近似鲁菜的做法，使个这道菜酸甜浓郁、开胃下饭、老少咸宜。",
          pic: "http://api.jisuapi.com/recipe/upload/20160719/115138_46688.jpg",
          tag: "减肥,家常菜,排毒,补钙",
          material: [
            { mname: "淀粉", type: 0, amount: "适量" },
            { mname: "糖", type: 0, amount: "适量" },
            { mname: "酱油", type: 0, amount: "适量" },
            { mname: "醋", type: 0, amount: "适量" },
            { mname: "蒜", type: 0, amount: "适量" },
            { mname: "姜", type: 0, amount: "适量" },
            { mname: "葱", type: 0, amount: "适量" },
            { mname: "干红椒", type: 0, amount: "适量" },
            { mname: "花椒", type: 0, amount: "适量" },
            { mname: "盐", type: 0, amount: "适量" },
            { mname: "油", type: 0, amount: "适量" },
            { mname: "白菜", type: 1, amount: "380g" },
          ],
          process: [
            {
              pcontent: "准备食材。",
        ...
        },
        {
          ...
          cookingtime: "10分钟内",
          content:
            "大白菜是过去物资匮乏年代冬天里的当家菜，虽然现在冬天蔬菜品种一点也不少了，但是人们一到冬天就不自觉的习惯性的要储存几颗，至少下雪刮大风出不去门的话家里有菜也不着急没得吃。我家离早市非常近，所以我不储存，但是我家冬天也不少吃白菜，无论炒着吃做包子饺子馅儿都很爱吃，尤其我家老公更是说每天吃炖白菜也不会腻烦，嘿嘿。一般我把白菜分三部分吃，最外面的几片留起来做馅儿吃，然后里面的部分叶子做汤，帮子就做醋熘白菜或者炒白菜丝，一点不浪费吧，哈哈。",
          pic: "http://api.jisuapi.com/recipe/upload/20160719/115155_93501.jpg",
          tag: "下饭菜,减肥,开胃,补钙",
          material: [
            { mname: "陈醋", type: 0, amount: "适量" },
            { mname: "盐", type: 0, amount: "适量" },
            { mname: "玉米淀粉", type: 0, amount: "适量" },
            { mname: "彩椒", type: 0, amount: "适量" },
            { mname: "蒜末", type: 0, amount: "适量" },
            { mname: "生抽", type: 0, amount: "适量" },
            { mname: "葱", type: 0, amount: "适量" },
            { mname: "姜片", type: 0, amount: "适量" },
            { mname: "白菜帮", type: 1, amount: "400g" },
          ],
          process: [
            {
            ...
            {
              pcontent:
                "然后用刀斜着改刀，将白菜帮子片成片（这样的切法可以令切好的白菜块的表面积增大，受热更均匀更容易入味）",
        ...
        },
        {
          ...
          cookingtime: "10-20分钟",
          content:
            "开水白菜是四川传统名菜，原系川菜名厨黄敬临在清宫御膳房时创制。后来黄敬临将此菜制法带回四川，广为流传。30多年前，川菜大师罗国荣调来北京饭店掌厨，又将“开水白菜”的烹调技术带回北京，从而成为北京饭店高档筵席上的一味佳肴。<br />千万别以为“开水”就是“白开水”， 开水白菜名说开水，实则是巧用清汤，其关键在于吊汤，汤要味浓而清，清如开水一般，成菜乍看如清水泡着几棵白菜心，一星油花也不见，但吃在嘴里，清鲜淡雅，香味浓醇，汤味浓厚，不油不腻，却清香爽口。<br />因为汤清澈见底，视之如开水，故名之“开水白菜”。",
          pic: "http://api.jisuapi.com/recipe/upload/20160719/115218_38602.jpg",
          tag: "健脾,家常菜,排毒,瘦身",
          material: [
            { mname: "盐", type: 0, amount: "适量" },
            { mname: "鸡精", type: 0, amount: "适量" },
            { mname: "料酒", type: 0, amount: "适量" },
            { mname: "胡椒粉", type: 0, amount: "适量" },
            { mname: "淀粉", type: 0, amount: "适量" },
            { mname: "娃娃菜", type: 1, amount: "2棵" },
            { mname: "高汤", type: 1, amount: "300g" },
          ],
          process: [
            {
              pcontent: "娃娃菜",
        ...
        },
        {
          ...
          cookingtime: "10分钟内",
          content:
            "哥哥腌制的咸白菜，没有等到变色我就嚷嚷要吃了，哥哥就给了一点，叫我先拿着吃，等几天再去拿，喜欢自家腌制的咸白菜，买的好咸受不了，咸白菜配冬笋和红萝卜一起烹制的，真的好鲜美，有了它，早上会多喝一碗粥呢。",
          pic: "http://api.jisuapi.com/recipe/upload/20160719/115314_95935.jpg",
          tag: "冬季,炒,私房菜,减肥,瘦身,肥胖",
          material: [
            { mname: "油", type: 0, amount: "适量" },
            { mname: "盐", type: 0, amount: "适量" },
            { mname: "胡萝卜", type: 0, amount: "适量" },
            { mname: "老干妈油辣椒", type: 0, amount: "适量" },
            { mname: "鸡精", type: 0, amount: "适量" },
            { mname: "冬笋", type: 1, amount: "500g" },
            { mname: "咸白菜", type: 1, amount: "300g" },
          ],
          process: [
            {
              pcontent: "冬笋去壳切开",
        ...
        },
        {
          ...
          cookingtime: "10-20分钟",
          content:
            "一天，突然想把白菜的菜叶与菜梗分别做汤和炒蔬菜，白菜叶直接放入肉汤煮，白菜梗做了一道炒蔬，拿出前一天留下的香菇与冬笋，再泡些黑木耳，一道制作非常简单，吃口却是鲜美爽脆的香菇冬笋炒白菜梗出炉了，其实这道菜也是因为我懒得去买菜而凑合出来的。",
          pic: "http://api.jisuapi.com/recipe/upload/20160719/115334_89013.jpg",
          tag: "冬季,家常菜,晚餐,炒锅,瘦身",
          material: [
            { mname: "油", type: 0, amount: "适量" },
            { mname: "盐", type: 0, amount: "半小勺" },
            { mname: "蚝油", type: 0, amount: "1小勺" },
            { mname: "白砂糖", type: 0, amount: "少许" },
            { mname: "黑木耳", type: 0, amount: "少许" },
            { mname: "白菜", type: 1, amount: "500g" },
            { mname: "香菇", type: 1, amount: "6朵" },
            { mname: "冬笋", type: 1, amount: "1个" },
          ],
          process: [
            {
            ...
            {
              pcontent:
                "冬笋去壳，入锅内用水煮，水开后再煮5分钟，取出冷却后切片，香菇洗净切片",
        ...
        },
        {
          ...
          cookingtime: "10分钟内",
          content:
            "金针菇中含锌量比较高，有促进儿童智力发育和健脑的作用，在许多国家被誉为“益智菇”和“增智菇”。（来源于网络）",
          ...
          material: [
            { mname: "油", type: 0, amount: "适量" },
            { mname: "料酒", type: 0, amount: "适量" },
            { mname: "薄盐生抽", type: 0, amount: "适量" },
            { mname: "醋", type: 0, amount: "适量" },
            { mname: "蚝油", type: 0, amount: "适量" },
            { mname: "白菜", type: 1, amount: "200g" },
            { mname: "金针菇", type: 1, amount: "50g" },
            { mname: "腊肠", type: 1, amount: "1根 " },
          ],
          process: [
            {
              pcontent: "葱，蒜，腊肠切片",
        ...
        },
        {
          ...
          cookingtime: "1-2小时",
          content:
            "冬季养生滋补，一般都会用煲汤来补身。<br />各种营养食材根据其特有的效果在一起煲汤，给我们的身体增加营补给。<br />我家每天中午都会煲汤，根据季节的变换换着花样。<br />猪蹄汤既营养又滋补，而且不会油腻，是我家大小都爱的，这道汤适合冬季滋补，加入一些黄豆和冬季当家菜大白菜，可补充身体的蛋白质和钙质，即滋补又能美容。",
          pic: "http://api.jisuapi.com/recipe/upload/20160719/115416_65189.jpg",
          tag: "汤,丰胸,催乳,通乳,下奶,乳腺增生,内分泌失调",
          material: [
            { mname: "姜", type: 0, amount: "适量" },
            { mname: "大料", type: 0, amount: "2个" },
            { mname: "鸡精", type: 0, amount: "少许" },
            { mname: "胡椒粉", type: 0, amount: "适量" },
            { mname: "料酒", type: 0, amount: "20ml" },
            { mname: "盐", type: 0, amount: "适量" },
            { mname: "葱", type: 0, amount: "适量" },
            { mname: "黄豆", type: 1, amount: "40g" },
            { mname: "大白菜", type: 1, amount: "2片" },
            { mname: "猪蹄", type: 1, amount: "1个" },
          ],
          process: [
            {
              pcontent: "黄豆提前浸泡一夜。",
        ...
        },
        {
          ...
          cookingtime: "10-20分钟",
          content:
            "冬季是大白菜的盛产季节，也是咱们冬季餐桌少不了的蔬菜。<br />大白菜，味道鲜美，营养丰富，素有“菜中之王”的美称，为广大群众所喜爱。<br />正如俗语说的：“肉中就数猪肉美，菜里唯有白菜鲜。”<br />还有一句俗话叫：白菜豆腐保平安，可见其营养价值。<br />冬季女性很多人都会有手脚冰凉，怕冷等症，那就多吃点白菜烧豆腐，通过获取充足的维生素B2，减少体内热量的快速的流失，从而提高机体的抗寒能力。<br />这款家常白菜豆腐汤最适合女性朋友冬季食用，可缓解手脚冰凉滋补暖身。",
          ...
          material: [
            ...
            { mname: "胡椒粉", type: 0, amount: "适量" },
            { mname: "鸡精", type: 0, amount: "适量" },
            { mname: "蒜苗", type: 0, amount: "适量" },
            { mname: "豆腐", type: 1, amount: "100g" },
            { mname: "大白菜", type: 1, amount: "100g" },
            { mname: "香菇", type: 1, amount: "4朵" },
            { mname: "胡萝卜", type: 1, amount: "50g" },
          ],
          process: [
            {
              pcontent: "准备好所有的食材。",
        ...
        },
        {
          ...
          cookingtime: "10-20分钟",
          content:
            "不知道 坐在办公室的你<br />是否<br />还记的当初的梦<br />是否<br />还记的大草原的天空 <br />还记的大草原的草<br /><br />做个独立女子<br />不管是生活<br />或是经济<br />都要好好爱自己",
          pic: "http://api.jisuapi.com/recipe/upload/20160719/115437_57683.jpg",
          tag: "美容,痰湿质,冬季,增强抵抗力,年菜,健脾养胃,立冬,小寒",
          material: [
            { mname: "黑胡椒粉", type: 0, amount: "适量" },
            { mname: "红辣椒", type: 0, amount: "适量" },
            { mname: "蒜", type: 0, amount: "适量" },
            { mname: "姜", type: 0, amount: "适量" },
            { mname: "大葱", type: 0, amount: "适量" },
            { mname: "盐", type: 0, amount: "适量" },
            { mname: "油", type: 0, amount: "适量" },
            { mname: "土豆", type: 1, amount: "200g" },
            { mname: "洋葱", type: 1, amount: "100g" },
            { mname: "豆腐", type: 1, amount: "200g" },
            { mname: "五花肉", type: 1, amount: "200g" },
            { mname: "辣白菜", type: 1, amount: "300g" },
          ],
          process: [
            {
            ...
            {
              pcontent:
                "锅底摸少许油,放入五花肉,听到嗞嗞啦啦的声音,将五花肉烤出点油来,倒入一点料酒爆香",
            ...
            {
              pcontent:
                "倒入水,没过所以材质为宜,加入盐,生抽,辣椒粉,辣白菜汤汁,以及少量的糖和黑胡椒粉调味",
        ...
        },
        {
          ...
          content:
            "大白菜是冬季餐桌上的常客，有“冬日白菜美如笋”之美誉，白菜中含有丰富的维生素C、E，在空气特别干燥的秋冬季，多吃白菜可以起到护肤和养颜效果。<br />而且大白菜含有丰富的钙，对不喜欢喝牛奶的人可以通过食用足量的大白菜来获得很多的钙。<br />鲢鱼头富含胶质蛋白，脂肪和热量都很低，食之有健脾补气、温中暖胃、美容润肤之效；<br />豆腐的蛋白质和钙含量丰富，有清热润燥、生津解毒、降低血脂的作用。<br />将鲢鱼头和嫩豆腐，白菜炖煮成汤饮用，而且借助鱼肉中维生素D可使钙的吸收提高很多倍。<br />此款汤适合冬季食用，暖身健脑，健脾补气，温中暖胃，使人皮肤润泽细腻，而且还是补充钙制得营养汤羹。<br />是老少皆宜的滋补养生汤。",
          pic: "http://api.jisuapi.com/recipe/upload/20160719/115444_31321.jpg",
          tag: "下奶,增强抵抗力,汤,美容,补钙,通乳",
          material: [
            { mname: "油", type: 0, amount: "适量" },
            { mname: "盐", type: 0, amount: "适量" },
            { mname: "葱姜", type: 0, amount: "适量" },
            { mname: "白酒", type: 0, amount: "5ml" },
            { mname: "胡椒粉", type: 0, amount: "3g" },
            { mname: "蒜苗", type: 0, amount: "适量" },
            { mname: "鲢鱼头", type: 1, amount: "1个" },
            { mname: "大白菜", type: 1, amount: "100g" },
            { mname: "豆腐", type: 1, amount: "200g" },
          ],
          process: [
  ...
  requestId: "bfa5e7fcc8524e8cadfc60a4e2007f6d",
};
